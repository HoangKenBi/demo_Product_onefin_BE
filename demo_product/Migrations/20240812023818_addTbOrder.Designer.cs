...
namespace demo_product.Migrations
{
    ...
    [Migration("20240812023818_addTbOrder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderDetailProduct", b =>
                {
                    ...
                    b.HasKey("ProductsidProduct", "idProduct");
            ...
            modelBuilder.Entity("OrderDetailProduct", b =>
                {
                    b.HasOne("demo_product.Entity.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsidProduct")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("demo_product.Entity.OrderDetail", null)
                        .WithMany()
